...
STEPS: list[Step] = [
    ...
    Step("2", "scrapers.scrape_weather", dep_key="scrapers.scrape_weather", category="sheets_partial"),
    Step("3", "scrapers.scrape_lineups", dep_key="scrapers.scrape_matchups", category="sheets_partial"),
    Step("4", "scrapers.scrape_matchups", dep_key="scrapers.scrape_matchups", category="sheets_partial",
         produces=["today_matchups.csv"]),
    Step("5", "scrapers.scrape_fangraphs", category="fangraphs",
         produces=["vs_RHP_standard.csv", "vs_RHP_batted_ball.csv",
                   "vs_LHP_standard.csv", "vs_LHP_batted_ball.csv", "sp_standard.csv"]),
    Step("6", "core.compute", dep_key="core.compute",
         produces=["metrics_vs_RHP.csv", "metrics_vs_LHP.csv"]),
    Step("7", "outputs.push_sheets", dep_key="outputs.push_sheets", category="sheets_push"),
    Step("8", "scrapers.scrape_pitch_mix", produces=["pitch_mix_pitcher.csv"]),
