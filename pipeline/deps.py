...
STEP_DEPENDENCIES: dict[str, list[str]] = {
    ...
    "scrapers.scrape_batter_gamelog": ["player_registry.csv", "batter_splits_overall.csv"],
    "core.compute_batter_prop_hitrates": ["batter_gamelog.csv"],
    "outputs.push_batter_prop_hitrates": ["batter_prop_hitrates.csv"],
