...
(function (global) {
  ...
  function injectStyles() {
    ...
    var css =
      ...
      'min-height:44px;box-sizing:border-box;border-radius:10px;padding:11px 14px;font-size:13.5px;font-weight:600;cursor:pointer;' +
      ...
      '.mlbma-auth-otp[hidden]{display:none;}' +
