...
function profileWindowFieldsFromRow(row) {
  ...
  function renderResearchHome() {
    ...
    root.innerHTML = '<div class="rl-home-header"><h2 class="rl-workspace-title">Research Home</h2>'
      + '<p class="rl-workspace-subtitle">' + esc(titleCaseDesc('Choose a research path — no giant tables on this screen.')) + '</p></div>'
  ...
  function renderModelLinks() {
    ...
    var cards = [
      ...
      { href: 'matchup_compare.html', title: 'Matchup Analysis', desc: 'Lineups, starters, and bullpens for one game.' },
