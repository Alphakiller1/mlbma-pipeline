...
(function(global) {
  ...
  function ensureStyles() {
    ...
    style.textContent = ''
      ...
      + '.thm-title{font-size:44px;line-height:1;font-weight:800;letter-spacing:-.02em;color:color-mix(in srgb, var(--text,#f4f4f7) 10%, transparent);margin:0 0 10px}'
      ...
      + '.thm-label{font-size:13px;letter-spacing:0;color:var(--text-2,#a1a1aa);font-weight:500;line-height:1}'
      + '.thm-pills{display:flex;flex-wrap:wrap;gap:6px}'
      + '.thm-pill{border:0.5px solid var(--border,#26262f);background:var(--surface-2,#14141e);color:var(--text-2,#a1a1aa);font-size:12px;font-weight:700;padding:6px 14px;border-radius:var(--r-pill,999px);cursor:pointer;line-height:1.1}'
      ...
      + '.thm-table thead th{background:transparent;color:var(--text-2,#a1a1aa);font-size:13px;text-transform:none;letter-spacing:0;padding:6px 6px;border-radius:0;text-align:left;white-space:nowrap;font-weight:700}'
      + '.thm-table thead th.sortable{cursor:pointer;user-select:none}'
      + '.thm-cell{padding:12px 12px;border-radius:var(--r-sm,8px);font-weight:700;color:var(--bg,#050509);min-width:120px;text-align:center;font-size:13px;box-shadow:inset 0 0 0 1px rgba(0,0,0,.02)}'
