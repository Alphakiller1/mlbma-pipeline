...
(function(global) {
  ...
  function ensureStyles() {
    ...
    style.textContent = ''
      + '.thm-wrap{margin-top:8px;background:#1b1b20;border:1px solid #2b2b33;border-radius:14px;padding:16px}'
      + '.thm-title{font-size:44px;line-height:1;font-weight:800;letter-spacing:-.02em;color:rgba(244,244,247,.08);margin:0 0 10px}'
      ...
      + '.thm-label{font-size:13px;letter-spacing:0;color:#a1a1aa;font-weight:500;line-height:1}'
      ...
      + '.thm-table thead th{background:transparent;color:#a1a1aa;font-size:13px;text-transform:none;letter-spacing:0;padding:6px 6px;border-radius:0;text-align:left;white-space:nowrap;font-weight:700}'
      ...
      + '.thm-team{display:flex;align-items:center;gap:8px;padding:0 6px;min-width:120px;color:#f4f4f7}'
      + '.thm-team strong{font-size:13px}'
      + '.thm-team-logo{width:24px;height:24px;border-radius:50%;object-fit:contain;background:#0f0f14;border:1px solid #3a3a44}'
